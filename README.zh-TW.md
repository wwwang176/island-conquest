...
| **防禦兵 (Defender)** | 0.8 | 180ms | 低 (0.45) | 謹慎據守 |
| **側翼兵 (Flanker)** | 0.75 | 160ms | 中 (0.65) | 繞側突擊 |
| **支援兵 (Support)** | 0.7 | 190ms | 中 (0.55) | 壓制與封區 |
| **狙擊手 (Sniper)** | 0.9 | 150ms | 低 (0.50) | 遠程精準 |
| **隊長 (Captain)** | 0.8 | 170ms | 中 (0.60) | 小隊指揮、均衡 |
